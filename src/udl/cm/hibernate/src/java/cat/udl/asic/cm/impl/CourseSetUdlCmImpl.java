/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/edu-services/branches/edu-services-1.2.x/cm-service/cm-impl/hibernate-impl/hibernate/src/java/org/sakaiproject/coursemanagement/impl/CourseSetUdlCmImpl.java $
 * $Id: CourseSetUdlCmImpl.java 59674 2009-04-03 23:05:58Z arwhyte@umich.edu $
 ***********************************************************************************
 *
...
public class CourseSetUdlCmImpl extends AbstractMembershipContainerUdlCmImpl
	...
	public CourseSetUdlCmImpl() {			
		}
	
	public CourseSetUdlCmImpl(String eid, String title, String description, String category, CourseSet parent) {
		this.eid = eid;
		this.title = title;
