...
<f:view>
	...
	<h:form>
		...
		<tr><td align="center">
			<h3><h:outputText value="#{msgs.text_assist_historic1}"/> <h:outputText value="#{HDesk_operador.ticket_sel}"/> </h3>
		</td></tr>
		...
		<tr><td>
			...
			<h:inputTextarea  required="false" cols="80" rows="7" style="font-size: 12;" styleClass="text" value="#{HDesk_operador.assistencia.consulta}" readonly="true"/>			
		</td></tr>
		<tr><td>
