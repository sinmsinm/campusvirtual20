...
<f:view>
	...
	<h:form>
		...
		<tr><td align="center">
			<h3><h:outputText value="#{msgs.text_assist_admin3}"/> <h:outputText value="#{HDesk_responsable.ticket_sel}"/></h3>
		</td></tr>
		...
		<tr><td width="25%">
			...
			<td>
                        ...
                        <h:selectBooleanCheckbox value="#{HDesk_responsable.envia_correu_usuari}" required="false" disabled="false" />
                        </td>
			</td></tr><tr><td>
			...
			<h:selectOneMenu value="#{HDesk_responsable.tecnic_sel}" style="background:#f8ffbe">
				<f:selectItem itemValue="" itemLabel="..." />
				<f:selectItems value="#{HDesk_responsable.operadors}" />
  			</h:selectOneMenu>   
  			<td>
				<h:outputText value="#{msgs.text_assist_historic18}" style="font-size: 12;"/>
  				<h:selectBooleanCheckbox value="#{HDesk_responsable.envia_correu}" required="false" disabled="false" />
  			</td>	
  			</td></tr><tr><td></td><td>
			...
			<h:outputText value="#{msgs.text_assist_historic17}" style="font-size: 12;"/></td><td>
				<h:selectOneMenu value="#{HDesk_responsable.categoria_selec_tipus}" style="background:#f8ffbe">
					  			<f:selectItem itemValue="" itemLabel="..." />
					  			<f:selectItems value="#{HDesk_responsable.llistaCategoria_tipus}" />
  				</h:selectOneMenu>   
			...
			<h:selectOneMenu id="menuTipus2" value="#{HDesk_responsable.prioritat_sel}" required="false" style="background:#f8ffbe">
			...
			<h:outputText value="#{msgs.text_assist_admin1}" style="font-size: 12;"/></td><td>
								<h:outputText value="#{HDesk_responsable.assistencia.nom_estat}" style="font-weight: bold; font-size: 12;"/>
								<h:outputText value="#{msgs.canvi}" />
			<h:selectOneMenu id="menuTipus1"  value="#{HDesk_responsable.estat_sel}" required="false" style="background:#f8ffbe">
						<f:selectItem itemValue="" itemLabel="..." />
		...
		<tr><td>
			...
			<h:inputTextarea required="false" cols="69" rows="7" style="font-weight: bold; font-size: 12; color: #777777;" styleClass="text" value="#{HDesk_responsable.assistencia.consulta}" readonly="true"/>			
			...
			<h:inputTextarea required="false" cols="80" rows="4" style="font-size: 12;" styleClass="text" value="#{HDesk_responsable.seguiment}" />			
			...
			<h:outputText value="#{msgs.text_assist_historic20}" style="font-size: 12;"/><br>
                        ...
                        <h:inputTextarea required="false" cols="80" rows="4" style="font-size: 12;background:#ffffe4" styleClass="text" value="#{HDesk_responsable.seguiment_intern}" />

		</td><td></td></tr>
		<tr><td align="center">
		<sakai:button_bar>
			<sakai:button_bar_item value="#{msgs.boto_desar}" action="#{HDesk_responsable.processActionDesarAssistencia}" />
			<sakai:button_bar_item value="Tornar enrere" action="#{HDesk_responsable.RetornaCons}" /> 
			<sakai:button_bar_item value="#{msgs.boto_informe}" action="#{HDesk_responsable.imprimeixUnaAssistencia}" rendered="#{HDesk_responsable.isHistoric==0}"/>
		</sakai:button_bar>
		</td></tr>
