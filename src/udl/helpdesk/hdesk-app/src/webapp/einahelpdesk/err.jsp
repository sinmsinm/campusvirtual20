...
<f:view>
	<sakai:view_container title="#{msgs.sample_title}">
		<h:form>
			<sakai:tool_bar>
				<sakai:tool_bar_item action="#{HDesk.RetornaMain}"	value="#{msgs.text_error2}" />
			</sakai:tool_bar>			
		</h:form>
		<sakai:view_content>
			<p valign="middle" align="center">
				<h:outputText value="#{msgs.text_error}" style="font-weight: bold;"/> <br>
				<h:outputText value="#{msgs.text_error1}" style="font-weight: bold;"/> <br>
			</p>
		</sakai:view_content>
