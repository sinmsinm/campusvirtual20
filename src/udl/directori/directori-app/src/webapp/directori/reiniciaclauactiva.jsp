...
<f:view>
	...
	<div class="container-fluid">
		...
		<h:panelGroup styleClass="col-xs-12 alert alert-danger"> <h:outputText escape="false" value="#{msgs.canviclauintroactiva}" /></h:panelGroup>
		<p><h:outputText value="#{msgs.canviclauactivainfo}" escape="false" /></p>
		<h:form>
		  		<h:commandButton styleClass="btn btn-primary sendButton" action="#{RecordaTool.goToActiva}" value="#{msgs.canviclauactivaboto}"/>
		  		<h:commandButton styleClass="btn btn-secondary sendButton" action="#{RecordaTool.goToReinicia}" value="#{msgs.recordatorna}"/>
		</h:form>
	</div>
</f:view>
