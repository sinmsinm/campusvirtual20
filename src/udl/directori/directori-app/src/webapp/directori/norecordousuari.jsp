...
<f:view>
	...
	<div class="container-fluid">
		...
		<h:panelGroup rendered="#{RecordaTool.errorMsg != null && RecordaTool.errorMsg != ''}" styleClass="col-xs-12 alert alert-danger"> <h:outputText escape="false" value="#{RecordaTool.errorMsg}" /></h:panelGroup>
		<p><h:outputText value="#{RecordaTool.norecordoInfo}" escape="false" /></p>
	
		<h:form styleClass="myForm">
	  			<div class="row form-group form-group-lg">
		   			<label class="col-sm-8"><h:outputText value="#{msgs.recordatorilabel}" /></label>
		    		 <div class="col-sm-8">
		    			<h:inputText styleClass="form-control" value="#{RecordaTool.email}" />
		    		</div>
		  		</div>
		  		...
		  		<div class="form-group">
			  		...
			  		<h:commandButton styleClass="btn btn-primary sendButton" action="#{RecordaTool.recordaUsuari}" value="#{msgs.recordatoribotoenvia}"/>
			  		<h:commandButton styleClass="btn btn-secondary" action="#{RecordaTool.goToMain}" value="#{msgs.recordacancela}"/>
			  	</div> 
	    	</div>
		</h:form>
</f:view>
