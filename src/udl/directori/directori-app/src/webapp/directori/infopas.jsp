        ...
        <h:form>
                ...
                <td>
                        <h:panelGrid columns="2" rowClasses="borderGrayBackground,borderWhite">
                                ...
                                <h:outputText  value="#{msgs.info_fax}" style="font-weight: bold;"/>
                                <h:outputText  value="#{DirectoriTool.assistent.fax}" />
								<h:outputText  value="#{msgs.webpersonal}" style="font-weight: bold;"/>
                                <h:outputLink  target="_bank" value="#{DirectoriTool.assistent.webpersonal}" >
                                	<h:outputText  value="#{DirectoriTool.assistent.webpersonal}" />
                                </h:outputLink>
                                <h:outputText  value="#{msgs.missatgeria}" style="font-weight: bold;"/>
                                <h:outputText  value="#{DirectoriTool.assistent.missatgeria}" />
