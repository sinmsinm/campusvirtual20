...
<f:view>
	...
	<div class="container-fluid">
		...
		<p><h:outputText value="#{RecordaTool.canviaclauInfo}" escape="false" /></p>
	
		<h:form styleClass="myForm">
	  			<div class="row form-group form-group-lg">
		   			<label class="col-sm-8"><h:outputText value="#{msgs.canviclaulabel}" /></label>
		    		 <div class="col-sm-8">
		    			<h:inputText styleClass="form-control" value="#{RecordaTool.username}" />
		    		</div>
		  		</div>
		  		...
		  		<div class="form-group">
					<div class="btn btn-primary processButton disabled" style="display:none" ><i class="glyphicon glyphicon-repeat normal-right-spinner"></i> Processant... </div>
			  		<h:commandButton styleClass="btn btn-primary sendButton" action="#{RecordaTool.reiniciaClau}" value="#{msgs.canviclaubotoenvia}"/>
