...
<f:view>
	...
	<div class="container-fluid">
		...
		<h:panelGroup styleClass="col-xs-12 alert alert-success"> <h:outputText escape="false" value="#{msgs.canviclaureiniciasuccess}" /></h:panelGroup>
		<p><h:outputText value="#{msgs.canviclaureiniciasuccessinfo}" escape="false" /></p>
		<h:form>
