...
public interface DataCollectorService {
		...
		public DataSourceValue getDataSourceValue (SectionInfo currentSectrion,DataSource currentDataSource);
		public boolean saveDataSourceValue(SectionInfo currentSectrion,DataSource dataSource, DataSourceValue dataSourceValue);
		public boolean deleteDataSourceValue(SectionInfo currentSectrion,DataSource dataSource, String key);
