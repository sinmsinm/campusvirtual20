...
public class ActivaEnquestaCV implements Job {

	//Inicialitzem el log
	static Logger M_log = Logger.getLogger(ActivaEnquestaCV.class);
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		M_log.info("EnquestaLleng: Execucio JOB - activacio de enquesta a alumnat que la te activada a CV");
					...
					if (login != null) {
						...
						if (user != null) {
							...
							if (preferences != null) {
								...
								M_log.info ("EnqLleng: propietat udlFirstYearTutorial afegida a " + login);
							}
