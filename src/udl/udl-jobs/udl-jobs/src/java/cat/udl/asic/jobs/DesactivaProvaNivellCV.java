...
public class DesactivaProvaNivellCV implements Job {

	//Inicialitzem el log
	static Logger M_log = Logger.getLogger(DesactivaProvaNivellCV.class);
	...
	//SQLs que s'hauran d'executar (bd enquesta primer)
	static String	SQL_TOTS_VISTA = "SELECT LOGIN FROM PENDENTS_FER_PROVA_NIVELL_LOC";
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		M_log.info("EnqueLleng: Execucio JOB - Desactivacio de la prova de nivell a alumnat que la te activada a CV");
					...
					if (login != null) {
						...
						if (user != null) {
							...
							if (preferences != null) {
								...
								props.removeProperty("udlTestAngles");	
								preferencesService.commit(preferences);
								M_log.info ("EnqLleng: propietat udlTestAngles eliminada a " + login);
							}
