...
public class ActivaProvaNivellCV implements Job {

	//Inicialitzem el log
	static Logger M_log = Logger.getLogger(ActivaProvaNivellCV.class);
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		M_log.info("EnqueLleng: Execucio JOB - Activacio de la prova de nivell a alumnat que la te activada a CV");
					...
					if (login != null) {
						...
						if (user != null) {
							...
							if (preferences != null) {
								...
								M_log.info ("EnqLleng: propietat udlTestAngles afegida a " + login);
							}
